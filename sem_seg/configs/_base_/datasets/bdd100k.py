...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        img_dir=data_root + "images/10k/train",
        ann_dir=data_root + "labels/sem_seg/masks/train",
        pipeline=train_pipeline,
    ),
    val=dict(
        type=dataset_type,
        img_dir=data_root + "images/10k/val",
        ann_dir=data_root + "labels/sem_seg/masks/val",
